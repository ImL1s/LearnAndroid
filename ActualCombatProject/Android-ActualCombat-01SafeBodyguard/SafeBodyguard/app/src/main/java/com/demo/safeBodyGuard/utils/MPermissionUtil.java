...
{
    /**
     * 當前請求權限的上下文不是Activity or Fragment
     */
    public static final int REQUEST_CODE_NOT_ACTIVITY_OR_FRAGMENT = -1;


    /**
     * 當請求碼為-1代表當前請求權限的上下文不是Activity or Fragment
     */
    private static int mRequestCode = REQUEST_CODE_NOT_ACTIVITY_OR_FRAGMENT;
    ...
    private static void requestPermissions(Object object, int requestCode, String[] permissions, OnPermissionListener callback)
    {
        ...
        else
        {
            ...
            if (deniedPermissions.size() > 0)
            {
                ...
                {
                    mRequestCode = REQUEST_CODE_NOT_ACTIVITY_OR_FRAGMENT;
                }
            }
        }
    }
    ...
    {
        if (mRequestCode != REQUEST_CODE_NOT_ACTIVITY_OR_FRAGMENT && requestCode == mRequestCode)
        {
